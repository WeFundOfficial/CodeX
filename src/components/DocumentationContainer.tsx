...
import styles from "./DocumentationContainer1.module.css";
const DocumentationContainer1: FunctionComponent = () => {
  return (
    <div className={styles.cardBottomParent}>
      ...
      <DiscussionForm1 getInvolvedDisplay="inline-block" />
...
export default DocumentationContainer1;
