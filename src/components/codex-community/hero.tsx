...
const Hero = () => {
  return (
    ...
    >
      <span className="text-[#54ABEE] text-sm lg:text-xl">Developer Resources</span>
      <h1 className=" text-3xl lg:text-5xl font-bold leading-[150%] lg:w-[550px] mt-8">
        CodeX Us Designed For Those Who Thrilled To Tot Quit
      </h1>
