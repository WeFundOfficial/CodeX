...
import styles from "./UpgradeabilityCard1.module.css";

type UpgradeabilityCardType = {
  featuresText?: string;
...
const UpgradeabilityCard1: FunctionComponent<UpgradeabilityCardType> = ({
  featuresText,
...
export default UpgradeabilityCard1;
