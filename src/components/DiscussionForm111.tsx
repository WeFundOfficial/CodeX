...
import styles from "./DiscussionForm1111.module.css";

type DiscussionForm111Type = {
  /** Style props */
  getInvolvedDisplay?: Property.Display;
};

const DiscussionForm1111: FunctionComponent<DiscussionForm111Type> = ({
  getInvolvedDisplay,
}) => {
...
export default DiscussionForm1111;
