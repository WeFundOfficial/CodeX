...
import styles from "./UpgradeabilityCard1111.module.css";

type UpgradeabilityCard111Type = {
  featuresText?: string;
...
const UpgradeabilityCard1111: FunctionComponent<UpgradeabilityCard111Type> = ({
  featuresText,
...
export default UpgradeabilityCard1111;
