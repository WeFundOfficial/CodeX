...
import styles from "./CodexContainer11111.module.css";
const CodexContainer21111: FunctionComponent = () => {
  return (
      ...
      <div className={styles.frameParent}>
        <div className={styles.missionParent}>
          ...
          <div className={styles.supportCodexInContainer}>
            <p className={styles.theCodexFoundation}>
              Support Codex in to ensure the growth of the network, fostering a
              strong and evolving ecosystem, and attracting builders and
              developers to continually improve the infrastructure of the Codex
              Ecosystem to reach the goal for mass adoption.
            </p>
          </div>
        </div>
...
export default CodexContainer21111;
