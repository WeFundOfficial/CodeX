...
import styles from "./UpgradeabilityCard11111.module.css";

type UpgradeabilityCard1111Type = {
  featuresText?: string;
...
const UpgradeabilityCard11111: FunctionComponent<
  UpgradeabilityCard1111Type
> = ({
  featuresText,
...
export default UpgradeabilityCard11111;
