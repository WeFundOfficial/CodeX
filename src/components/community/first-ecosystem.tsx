...
const Ecosystem = () => {
  return (
    <div className="flex flex-col lg:flex-row lg:gap-48 w-full pb-12 px-4 lg:px-40 items-center relative right-markbar"
      style={{ background: "linear-gradient(280.57deg, rgba(10, 35, 252, 0.5) 0%, rgba(0, 8, 77, 0) 35%)" }}
    >
      <h1 className="text-3xl lg:text-5xl font-semibold mt-12 !leading-normal">
