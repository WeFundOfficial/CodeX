...
const Ecosystem = () => {
  return (
    <div className="flex w-full pb-12 px-40 items-center relative right-markbar">
      <h1 className="text-5xl text-white mt-12">
      ...
      <div className="mt-12">
        ...
        <p className="text-xl text-white mt-6 w-[500px]" style={{maxWidth: "500px"}}>
