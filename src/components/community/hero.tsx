...
const Hero = () => {
  return (
    ...
    >
      <h1 className="text-white text-3xl lg:text-5xl font-bold leading-[150%]">
        Building Widely-Used<br />Web3 Applications.
      </h1>
      <p className="text-white text-sm lg:text-xl max-w-5xl mt-8">
        CodeX is a dedicated project for the mass adoption of<br />blockchain users.
      </p>
      <div className="flex gap-4 lg:gap-8 mt-8">
        <button className="w-40 lg:w-56 h-12 lg:h-16 p-1 lg:p-2 rounded-lg text-white text-sm lg:text-lg"
          style={{
        ...
        <button className="w-40 lg:w-72 h-12 lg:h-16 p-1 rounded-lg text-white text-sm lg:text-lg"
          style={{
