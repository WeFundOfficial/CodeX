          ...
          <div className={styles.buildingWidelyUsedWeb3ApplParent}>
            ...
            >
              ...
              <span className={styles.ode}>
                {" "}
                is a dedicated project for the mass adoption of blockchain
                users.
              </span>
            </input>
              ...
              <div className={styles.xpanderParent}>
                ...
                >
                  ...
                  <span className={styles.forAllDevelopersWithoutAn}>
                    ...
                    <span className={styles.designed}>
                      pander is a block-based compiler smart contract derived
                      from several advanced languages ​​such as Rust, Solidity,
                      Ruby, Skala and many more. By implementing a
                      sequential-level programming structure, developers are
                      able to create no-code applications and contracts while
                      more advanced developers are able to contribute to convert
                      processing flows directly into working applications.
                      Veteran coders can continue to create compiler-level code
                      and contribute directly to the code libraries within the
                      CodeX protocol.
                    </span>
                  </span>
                </textarea>
              ...
              <div className={styles.iconParent}>
                ...
                <div className={styles.xpanderParent}>
                  ...
                  <div className={styles.designedForAll}>
                    Combining the Ethereum Virtual Machine (EVM) and CosmWasm
                    can provide developers with a powerful set of tools to build
            ...
            <div className={styles.iconParent}>
              ...
              <div className={styles.xpanderParent}>
                ...
                <div className={styles.designedForAll1}>
                  ...
                  adoption and development of blockchain technologies by
                  removing the common barriers to entering the industry - the
                  steep learning curve to build on web 3.0 infrastructures and
                  the ambiguous safety and security risks associated blockchain
          ...
          <div className={styles.lineContainer}>
            ...
            <div className={styles.frameParent1}>
              <div className={styles.cardBottomParent}>
                ...
                <form className={styles.cardBottom}>
                  <div className={styles.discussionForum1}>
                    Discussion Forum
                  </div>
                  <div className={styles.participateInOpen}>
                    <p
